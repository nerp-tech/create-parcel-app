 ...
 * Modified work Copyright (c) 2015-present, Facebook, Inc.
 *
...
const { defaultBrowsers } = require('./browsersHelper');
const os = require('os');
...
function tryGitInit(appPath) {
    ...
    try {
        ...
        execSync('git commit -m "Initial commit from Create Parcel App"', {
            stdio: 'ignore',
        });
        return true;
    } catch (e) {
...
module.exports = function (
    ...
    // which doesn't install react and react-dom along with parcel-scripts
